...
namespace test {
    ...
    bool test_minimize4() {
        ...
        add_state(expect);
        add_final_state(expect);
        add_transition(expect, 0, 1, Symbol("a"), Symbol("[01]&[12]&[23]"));
        add_transition(expect, 0, 2, Symbol("a"), Symbol("[07]&[78]"));
        add_transition(expect, 0, 3, Symbol("b"), Symbol("[01]&[14]&[45]"));
        add_transition(expect, 1, 1, Symbol("a"), Symbol("[36]&[61]&[12]&[23]"));
        add_transition(expect, 1, 2, Symbol("a"), Symbol("[36]&[67]&[78]"));
        add_transition(expect, 1, 3, Symbol("b"), Symbol("[36]&[61]&[14]&[45]"));
        add_transition(expect, 3, 1, Symbol("a"), Symbol("[56]&[61]&[12]&[23]"));
        add_transition(expect, 3, 2, Symbol("a"), Symbol("[56]&[67]&[78]"));
        add_transition(expect, 3, 3, Symbol("b"), Symbol("[56]&[61]&[14]&[45]"));
        add_transition(expect, 2, 4, Symbol("b"), Symbol("[89]"));
        add_transition(expect, 4, 5, Symbol("b"), Symbol("[910]"));
